...
export const TOWER_TYPES = Object.freeze([
  ...
  },
  {
    ...
    upgrades: [
      { name: "Bitter Mix", cost: 170, damage: 8, range: 8, fireRate: 0.08, special: { poisonDps: 2 } },
      { name: "Clinging Venom", cost: 320, damage: 12, range: 10, fireRate: 0.1, special: { poisonDuration: 1 } },
      { name: "Black Distillate", cost: 540, damage: 18, range: 14, fireRate: 0.12, special: { poisonDps: 4 } },
    ],
  },
  {
    id: "ballista",
